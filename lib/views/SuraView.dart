...
class SuraView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<HomeController>(
      builder: (controller) {
        return Scaffold(
          appBar: AppBar(
            backgroundColor: const Color(0xff748e46),
                        ...
                        onConfirmTaped: () {
                          WidgetsBinding.instance
                            ...
                            await controller.scrollToItem(
                                controller.player.currentIndex!.toInt());
                          });
                          Get.back();
                        });
                  },
        ...
        child: Padding(
          ...
          child: ScrollablePositionedList.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              var editeted = "";
              if (sura.number > 1) {
                editeted = string2.replaceFirstMapped(
                    'بِسْمِ ٱللَّهِ ٱلرَّحْمَٰنِ ٱلرَّحِيمِ', (m) => '');
              } else {
                editeted = verse.text;
              }
  ...
  Widget _buildContainer(
      String editeted, HomeController controller, int index) {
    return Container(
                          ...
                          children: [
                            StreamBuilder(
                                ...
                                builder:
                                  ...
                                  WidgetsBinding.instance
                                      .addPostFrameCallback((timeStamp) async {
                                    await controller.scrollToItem(controller
                                        .player.currentIndex!
                                        .toInt());
                                  });
